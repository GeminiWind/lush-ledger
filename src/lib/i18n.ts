...
const enUS: FlatDictionary = {
  ...
  savingsPlanArchiveAction: "Archive Plan",
  ...
  reportsUnifiedAnalysis: "Unified Financial Analysis",
  reportsUnifiedAnalysisSubtitle: "Visualizing your fiscal flow and budget adherence across time horizons.",
  reportsRangeFrom: "From",
  reportsRangeTo: "To",
  reportsSpendByCategory: "Spend by Category",
  reportsIncomeVsOutcome: "Income vs Outcome",
  reportsOutcome: "Outcome",
  reportsTotal: "Total",
  reportsNoExpenseData: "No expense data",
...
const viVN: FlatDictionary = {
  ...
  savingsPlanArchiveAction: "Lưu trữ kế hoạch",
  ...
  reportsUnifiedAnalysis: "Phân tích tài chính hợp nhất",
  reportsUnifiedAnalysisSubtitle: "Trực quan hóa dòng tiền và mức độ bám sát ngân sách theo từng mốc thời gian.",
  reportsRangeFrom: "Từ",
  reportsRangeTo: "Đến",
  reportsSpendByCategory: "Chi tiêu theo danh mục",
  reportsIncomeVsOutcome: "Thu nhập vs Chi ra",
  reportsOutcome: "Chi ra",
  reportsTotal: "Tổng",
  reportsNoExpenseData: "Chưa có dữ liệu chi tiêu",
...
const dictionarySections = {
  ...
  atelier: {
    ...
    report: [
      ...
      "reportsExportPdf",
      "reportsUnifiedAnalysis",
      "reportsUnifiedAnalysisSubtitle",
      "reportsRangeFrom",
      "reportsRangeTo",
      "reportsSpendByCategory",
      "reportsIncomeVsOutcome",
      "reportsOutcome",
      "reportsTotal",
      "reportsNoExpenseData",
    ],
  },
  ledger: [
    "ledgerToday",
