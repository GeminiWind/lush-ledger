...
import type { PrimarySavingsProgressChartProps } from "@/features/savings/types";

export default function PrimarySavingsProgressChart({ progress }: PrimarySavingsProgressChartProps) {
