...
import type { DailyCalendarProps } from "@/features/ledger/types";

const selectClassName =
  "appearance-none rounded-full border border-[#c3d8e5] bg-white py-2.5 pl-4 pr-10 text-sm font-semibold text-[#1b3641]";

export default function DailyCalendar({ language, currency, monthOptions, expenseEntries, labels }: DailyCalendarProps) {
