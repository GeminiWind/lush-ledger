...
import type { ExpenseBudgetChartProps } from "@/features/ledger/types";

export default function ExpenseBudgetChart({ rows, currency, title, actualLabel, budgetLabel }: ExpenseBudgetChartProps) {
  return (
